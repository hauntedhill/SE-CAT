...
public class RadarChart extends SpiderWebPlot {
	...
	private int radarTicks = 5;

	public RadarChart(DefaultCategoryDataset d, int ticks) {

		super();
		this.defaultCategoryDataset = d;
		this.radarTicks = ticks;
		plot = new SpiderWebPlot(defaultCategoryDataset) {
			/**
         * 
         */
			private static final long serialVersionUID = 1L;
			// put this many labels on each axis.
			private int ticks = radarTicks;
			 ...
			 */
			@Override
			protected void drawLabel(final Graphics2D g2, final Rectangle2D plotArea, final double value, final int cat, final double startAngle,
					final double extent) {
